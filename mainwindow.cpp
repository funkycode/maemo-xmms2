...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent),
      ...
      xmms2control(new xmms2con(this))
{

    ui->setupUi(this);
    if (!xmms2control->connect_xmms())
    {
        QMessageBox::warning(this, "Error", "can't connect to XMMS2");
        QApplication::quit();
    }
...
void MainWindow::on_stop_bt_clicked()
{
    ...
    xmms2control->stop_playback();
}
void MainWindow::on_next_bt_clicked()
{
   xmms2control->next_song();
}

void MainWindow::on_prev_bt_clicked()
{
    xmms2control->prev_song();
}
